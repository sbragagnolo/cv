...
\begin{rSection}{Travail en cours}
	\begin{rSubsection}{Berger Levrault}{Mai 2020 - Actuallement}{D\'efinition de position - Etudiant PhD}
		\item En contrat CDI dans le cadre de These Doctorant
		\item Migration de programmes legataires vers des architectures web: Le cas de la migration de programmes Microsoft Access vers Angular et Microservices. 
	\end{rSubsection}
\end{rSection}


\begin{rSection}{Exp\'{e}rience dans l'industrie et dans la recherche}
	\begin{rSubsection}{Inria}{Avril 2019 - Avril 2020}{D\'efinition de position - Ing\'{e}nieur recherche RMOD}
