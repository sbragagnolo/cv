...
\begin{rSection}{Synth\'{e}se d'experience}
	\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
		...
		Instructor SQL Oracle & 2 ann\'{e}es \\
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
	...
	French & \'{E}crit et parl\'{e} comp\'{e}tence haute \\
...
\begin{rSection}{Travail en cours}
	\begin{rSubsection}{INRIA}{Avril 2014 - Actuellement }{Definition de position - Ing\'{e}nieur transfert technologique}
	...
	\begin{rSubsection}{INRIA RMOD - Projet de transfert technologie}{Octobre 2016 - Actuellement }{Blockchain interactions}
		\item Analysis de recherche sur le sujet blockchain. 
	...
	\begin{rSubsection}{INRIA Non-A - Projet de transfert technologie}{Decembre 2015 - Mars 2016 }{Sephyr - Tablette intelligente }
		\item D\'{e}veloppement de prototype de tablette robotique, ger\'{e}e a travers de commands vocales. 
		\item Adaptation de algorithme de trajectoire pour bouger dans un espace ferm\'{e}
		\item Machine d'\'{e}tat pour le control de protocole vocale. 
		\item Driver de module d'interaction vocale.  
		\item Definition de model physique de robot - tablette . 
	...
	\begin{rSubsection}{INRIA RMOD Maturation technologie}{Juin 2016 - Actuellement }{Android Pharo VM}
		\item D\'{e}veloppement de l'adaptation du la  machine virtuelle du langage de programmation Pharo pour la platform android.
		\item D\'{e}velopp\'{e} sur Pharo 5.0, C et Java
	...
	\begin{rSubsection}{INRIA RMOD - Maturation technologie}{Juin 2016 - Actuellement }{Scale}
		\item Util pour �crire et executer des scripts en pharo. 
		\item D\'{e}velopp\'{e} sur Pharo 5.0 
		\item https://github.com/guillep/Scale		
	\end{rSubsection}
	\begin{rSubsection}{INRIA Non-A - Maturation technologie}{Octobre 2014 - Actuellement }{Makros}
	...
	\end{rSubsection}
	\begin{rSubsection}{INRIA Non-A - Maturation technologie}{Octobre 2014 - Actuellement }{ROSDDS/MetaDDS/SimpleDDS}
	...
	\end{rSubsection}
	\begin{rSubsection}{INRIA RMOD - Maturation technologie}{F\'{e}vrier 2014 - Actuellement }{TaskIT}
	...
	\end{rSubsection}
	\begin{rSubsection}{INRIA Non-A - Maturation technologie}{F\'{e}vrier 2014 - Actuallement }{Trajectory algorithms}
		\item Impl\'{e}mentation des algorithmes pour la planification locale de trajectoire pour des systemes diff\'{e}rentielles, bas\'{e}e sur methods de control adaptative 
...
\begin{itemize}
	...
	\begin{itemize}
		\item Patterns, Methodologies TDD/BDD, DDD, Agile, Re-factors, Meta-programming
	\end{itemize}
...
{\bf Universidad Tecnologica Nacional (UTN) - Ciudad de Buenos Aires - Argentine} \hfill {\em Janvier 2004 - Abandonn\'{e} en 2011 } \\ 
Software Engineer  \\
