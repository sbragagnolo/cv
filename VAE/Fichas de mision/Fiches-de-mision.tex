...
\pablo{Aca deberias hablar un poco más de Oceano, yo se que trabajaste con Tiburón, Delfin y Mojarrita, pero ellos no lo saben}	
	...
	\pablo{Fijate de que si usas courriers électroniques o courriels, pero no mezclados (courriels electroniques duplica) y si podes usar el mismo siempre mejor, cual te gusta mas?}
	...
	\subsubsection{Relations extérieures} 
		...
		\item \textbf{Avec quelle fréquence?}
			Au besoin. \pablo{pone una frecuencia aca, inventale una vez por mes o dos veces o por semana... algo, lo mismo con el de antes}
		\end {enumerate}			
