...
\begin{rSection}{Synth\'{e}se d'experience}
	\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
		...
		Exp\'{e}rience dans la recherche & 7 ann\'{e}es  \\
...
\begin{rSection}{Travail en cours}
	\begin{rSubsection}{Berger-Levrault}{Mai 2020 - Actuallement}{Candidat Docteur / Ing\'{e}nieur de Recherche et innovation}
		\item Premiere année de these
		\item Deux papier soumis : Quatic 2020 et ICRS 2020
		\item Development des outils et infrastructure pour la migration de logiciel vers nouvelles technologies. 
	\end{rSubsection}
\end{rSection}
...
\begin{rSection}{Exp\'{e}rience dans l'industrie et dans la recherche}
	...
	\begin{rSubsection}{Inria}{Avril 2019 - Mai 2020 }{Ing\'{e}nieur de Recherche}
		\item 
	...
	\begin{rSubsection}{Inria}{Avril 2015 - Avril 2019 }{Ing\'{e}nieur transfert technologique}
		\item 
